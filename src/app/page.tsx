          ...
          <div className="flex items-center justify-center h-28">
            ...
            <div className="flex-shrink-0 group cursor-pointer relative">
              <div className="relative overflow-hidden">
                ...
                <h1 className="text-6xl font-black bg-gradient-to-r from-black via-gray-800 to-black bg-clip-text text-transparent hover:from-gray-700 hover:via-black hover:to-gray-700 transition-all duration-700 transform group-hover:scale-110 relative z-10">
                  NOVITA
                </h1>
                
                {/* Efeito de Brilho Animado */}
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-black to-transparent opacity-0 group-hover:opacity-30 blur-2xl transition-all duration-700 transform -skew-x-12 group-hover:translate-x-full"></div>
                
                {/* Linha Decorativa Inferior */}
                <div className="absolute -bottom-3 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-black to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 transform scale-x-0 group-hover:scale-x-100"></div>
                
                {/* Pontos Decorativos */}
                <div className="absolute -top-2 -left-2 w-2 h-2 bg-black rounded-full opacity-0 group-hover:opacity-100 transition-all duration-500 delay-100"></div>
                <div className="absolute -top-2 -right-2 w-2 h-2 bg-black rounded-full opacity-0 group-hover:opacity-100 transition-all duration-500 delay-200"></div>
              </div>
              
              {/* Tagline Premium */}
              <div className="text-center mt-3 overflow-hidden">
                <p className="text-xs text-gray-600 font-bold tracking-[0.3em] opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-2 group-hover:translate-y-0">
                  PREMIUM SPORTS COLLECTION
                </p>
              </div>
              
              {/* Círculo de Fundo Sutil */}
              <div className="absolute inset-0 -z-10 w-32 h-32 bg-gradient-to-br from-gray-100 to-transparent rounded-full opacity-0 group-hover:opacity-100 transition-all duration-700 transform scale-0 group-hover:scale-150 blur-xl"></div>
            </div>
          </div>
        </div>
      </header>
